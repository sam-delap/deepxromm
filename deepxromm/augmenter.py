...
class Augmenter:
    ...
    def merge_datasets(self, update_nframes=True):
        ...
        for trial_path in self._data_processor.list_trials():
            ...
            outlier_csv = outlier_csv.loc[outliers, :]
            ...
            if trial_path.name in training_trial_names:
                ...
                df_combined.to_csv(current_trial_csv_path, index=False)
                continue
            ...
            # Update nframes to include outlier data in training data number (this can be disabled)
            if update_nframes:
