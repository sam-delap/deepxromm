...
> **Note:** DeepXROMM depends on DeepLabCut, which requires Python 3.10+. The `[cli]` optional dependency adds IPython for interactive use, but all core functionality works with the base package.
